/* mostra totes les maneres de posar n reines en un tauler n × n sense amenaçar-se */


// vegeu apunts de classe pel significat de les variables
...
void totes_reines(int n, vector<int>& q, vector<bool>& r, vector<bool>& d1, vector<bool>& d2, int i) {
    if (i == n) {
        escriure_reines(n, q);
    } else {
        for (int j = 0; j < n; ++j) {
