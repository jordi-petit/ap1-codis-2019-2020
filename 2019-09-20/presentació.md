...
Important: Comuniqueu-vos amb els vostres professors amb el correu *oficial* de la universitat (`@est.fib.upc.edu`).
...
- GitHub
  - Els codis escrits a l'ordinador durant les classes de teoria es podran anar trobant
    a https://github.com/jordi-petit/ap1-codis-2019-2020, organitzats per data i temes.

  - Els codis del curs passat són a
    a https://github.com/jordi-petit/ap1-codis-2018-2019.
...
Dates:
  - PL: dx 6 de nov, 12:00 a 15:00
  - FL: dj 17 de gen, 11:30 a 14:30
  - FT: dj 17 de gen, 16:00 a 19:00
